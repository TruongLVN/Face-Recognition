...
def split_data(path_data_set, path_train, path_test, path_valid):
	...
	path_groups = [os.path.join(path_data_set, group) for group in os.listdir(path_data_set)]
...
if __name__=="__main__":
	path_data_set = "../pre_dataset/aligned_dataset"
	path_train = "../pre_dataset/dataset/trainset"
	path_test = "../pre_dataset/dataset/testset"
	path_valid = "../pre_dataset/dataset/validset"
